...
const services: Service[] = [
  ...
  },
  {
    ...
    keyFeatures: ["Online booking with stylist preference", "Staff scheduling and commission tracking", "Loyalty points and rewards", "Service package management"],
    deliverables: ["Salon management platform", "Customer booking app", "Staff scheduling system", "Loyalty program setup"],
    timeline: "3-5 weeks",
    uniqueValue: "Clients can book their favorite stylist online, and loyalty points keep them coming back.",
  },
  {
    id: "32",
    ...
    keyFeatures: ["Order tracking with barcode tags", "Automatic pricing calculation", "WhatsApp status notifications", "Delivery scheduling"],
    deliverables: ["Laundry management system", "Customer notification setup", "Barcode tag printing", "Delivery route planning"],
    timeline: "3-5 weeks",
    uniqueValue: "Customers get WhatsApp updates at each stage - received, washing, ready - without you lifting a finger.",
  },
  {
    id: "33",
    ...
    keyFeatures: ["Online table reservation", "Digital menu with QR ordering", "Kitchen display system", "Split billing and POS"],
    deliverables: ["Restaurant management platform", "Kitchen display setup", "QR menu system", "Staff training"],
    timeline: "4-6 weeks",
    uniqueValue: "Orders go directly to the kitchen display, eliminating miscommunication and speeding up service.",
  },
  {
    id: "34",
    ...
    keyFeatures: ["Product catalog with variants", "AI-powered recommendations", "Secure checkout with multiple payments", "Inventory and order management"],
    deliverables: ["Full e-commerce website", "Admin dashboard", "Payment gateway setup", "SEO optimization"],
    timeline: "4-8 weeks",
    uniqueValue: "Our AI recommends products based on browsing behavior, increasing average order value by up to 35%.",
  },
  {
    id: "35",
    ...
    keyFeatures: ["Vendor self-onboarding portal", "Automated commission calculation", "AI fraud detection", "Split payments to vendors"],
    deliverables: ["Marketplace platform", "Vendor dashboard", "Admin controls", "Payment infrastructure"],
    timeline: "10-16 weeks",
    uniqueValue: "Our AI detects fraudulent listings and suspicious activity before they impact your customers.",
  },
  {
    id: "36",
    ...
    keyFeatures: ["Location-based listing search", "In-app chat between buyers/sellers", "Image upload and optimization", "Category and filter management"],
    deliverables: ["Classifieds web platform", "Mobile-responsive design", "Moderation tools", "Analytics dashboard"],
    timeline: "6-10 weeks",
    uniqueValue: "Smart location matching shows buyers the most relevant listings near them automatically.",
  },
  {
    id: "37",
    ...
    keyFeatures: ["Real-time inventory sync", "Delivery slot management", "Expiry date tracking", "Repeat order suggestions"],
    deliverables: ["Grocery e-commerce platform", "Delivery management system", "Customer mobile app", "Inventory sync setup"],
    timeline: "6-10 weeks",
    uniqueValue: "AI tracks expiry dates and automatically promotes soon-to-expire items, reducing food waste significantly.",
  },
  {
    id: "38",
    ...
    keyFeatures: ["Prescription upload and verification", "Medicine search with alternatives", "Automated refill reminders", "Drug interaction warnings"],
    deliverables: ["Pharmacy e-commerce platform", "Prescription management system", "Compliance documentation", "Customer notification setup"],
    timeline: "8-12 weeks",
    uniqueValue: "Our system checks for drug interactions and alerts pharmacists before dangerous combinations are dispensed.",
  },
  {
    id: "39",
    ...
    keyFeatures: ["Provider matching by location and rating", "Real-time booking and tracking", "In-app payments with tips", "Review and rating system"],
    deliverables: ["Customer mobile app", "Provider mobile app", "Admin dashboard", "Payment setup"],
    timeline: "10-14 weeks",
    uniqueValue: "Our matching algorithm considers ratings, availability, and proximity to send you the best provider every time.",
  },
  {
    id: "40",
    ...
    keyFeatures: ["Real-time vehicle availability", "Dynamic pricing engine", "Digital contract signing", "GPS tracking integration"],
    deliverables: ["Rental booking platform", "Fleet management dashboard", "Customer mobile app", "Pricing engine setup"],
    timeline: "8-12 weeks",
    uniqueValue: "AI optimizes pricing based on demand, season, and competition to maximize revenue per vehicle.",
  },
  {
    id: "41",
    ...
    keyFeatures: ["Room inventory management", "Dynamic pricing algorithms", "Channel manager integration", "Guest self-check-in"],
    deliverables: ["Hotel booking website", "Property management system", "Channel sync setup", "Guest mobile experience"],
    timeline: "8-14 weeks",
    uniqueValue: "Our dynamic pricing adjusts rates automatically based on occupancy, events, and competitor prices.",
  },
  {
    id: "42",
    ...
    keyFeatures: ["Multi-modal trip search", "Dynamic package builder", "AI trip recommendations", "E-ticket generation"],
    deliverables: ["Travel booking portal", "Agent booking interface", "Ticket management system", "Reporting dashboard"],
    timeline: "8-12 weeks",
