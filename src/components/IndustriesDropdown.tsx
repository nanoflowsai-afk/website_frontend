...
export function IndustriesDropdown({ onClose }: IndustriesDropdownProps) {
  return (
    <motion.div
      ...
      className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-[98vw] max-w-screen-2xl rounded-2xl border border-gray-100 bg-white shadow-2xl backdrop-blur-xl"
