...
export function IndustriesDropdown({ onClose }: IndustriesDropdownProps) {
  ...
  return (
    <motion.div
      ...
      className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-[97vw] max-w-[1500px] rounded-2xl border border-gray-100 bg-white shadow-2xl backdrop-blur-xl mx-auto"
