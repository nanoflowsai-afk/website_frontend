      ...
      <div className="relative overflow-hidden">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="grid grid-cols-3 gap-3 sm:gap-3 md:gap-4 sm:grid-cols-6"
          >
            {activeTech.map((tech) => (
              <div
                key={tech.name}
                className="group flex flex-col items-center justify-center gap-2 sm:gap-3 rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 transition-all duration-300 hover:-translate-y-2 hover:border-orange-300 hover:shadow-xl min-h-[110px] sm:min-h-[130px]"
              >
